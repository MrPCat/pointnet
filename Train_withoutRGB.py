...
# === Configure Logging ===
log_file_path = "/content/drive/MyDrive/training_logsNORGB.txt"
...
if __name__ == "__main__":
    ...
    # Specify File Paths
    train_file = '/content/drive/MyDrive/t1/train_noRGB.txt'
    val_file = '/content/drive/MyDrive/t1/Val_noRGB.txt'
